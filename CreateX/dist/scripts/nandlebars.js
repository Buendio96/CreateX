...
/* harmony import */ var _js_store_projectsStore__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @js-store/projectsStore */ "./src/scripts/store/projectsStore.mjs");
/* harmony import */ var _js_templates_work_item__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @js-templates/work-item */ "./src/scripts/templates/work-item.mjs");
...
await (0,_js_store_projectsStore__WEBPACK_IMPORTED_MODULE_3__.initGetData)(todayIs); //As the second argument can be the Number for the date range
const FILTRED_STORE = _js_store_projectsStore__WEBPACK_IMPORTED_MODULE_3__.PROJECTS_STORE.byDateProjects;
const skipLeft = document.getElementById('our-work-go-left');
const skipRight = document.getElementById('our-work-go-right');
FILTRED_STORE.forEach(item => {
  const card = (0,_js_templates_work_item__WEBPACK_IMPORTED_MODULE_4__.createCard)(item);
  console.log(card);
  ...
  const htmlString = `
	  <div class="portfolio-card">
		<div class="portfolio-card__img">
		  <img class="image-adaptive" src="assets/images/${item.imageName}" alt="The picture with ${item.name}">
		</div>
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/scripts/pages/homepage.js");
/******/ 	
/******/ })()
;
